          ...
          <Accordion>
            ...
            >
              <Typography component="span">
                چگونه یک مدرس مکتب‌خونه باشم؟
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              به عنوان مدرس در مکتب‌خونه ثبت‌نام انجام دهید. سپس از طریق پنلی که
              ...
              مکتب‌خونه در کنار شما هستند تا تجربه شیرینی از تدریس را برای شما
              رقم بزنند.
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            >
              <Typography component="span">
                مارکتینگ مکتب‌خونه چه مزیتی برای شما دارد؟
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
            کارشناسان مکتب‌خونه همه روزه در تلاش هستند تا دانشجویان مکتب‌خونه را بیشتر بشناسند تا دوره مناسب را به دانشجوی مورد نظر ارائه دهند. دانش ما از بررسی رفتار و نیازمندی‌های میلیون‌ها دانشجو در طی سالیان فعالیت مکتب‌خونه در ارائه دوره‌های آموزشی آنلاین به شما کمک می‌کند تا به تعداد مخاطبان وسیع‌تری از آنچه تا کنون در اختیار داشتید، دسترسی پیدا کنید. علاوه‌براین، استراتژی‌های مختلف مارکتینگ مکتب‌خونه به شما کمک خواهد کرد تا پتانسیل فروش دوره آموزشی خود را افزایش دهید که از آن جمله می‌توان به کمپین‌های دوره‌ای، تبلیغات در وبسایت‌های مختلف، سئو در گوگل، ایمیل مارکتینگ، اس ام اس مارکتینگ، پوش نوتیفیکیشن و غیره اشاره کرد.
            </AccordionDetails>
          </Accordion>
          <Accordion>
            <AccordionSummary
            ...
            <AccordionDetails>
              کارشناسان مکتب‌خونه همه روزه در تلاش هستند تا دانشجویان مکتب‌خونه
              ...
              سالیان فعالیت مکتب‌خونه در ارائه دوره‌های آموزشی آنلاین به شما کمک
              ...
              مکتب‌خونه به شما کمک خواهد کرد تا پتانسیل فروش دوره آموزشی خود را
